...
(def$method (active-value-mixin :active-value-get) (value slot-name prop-name)
...
(def$method (active-value-mixin :get-behavior) (active-value)
  "selects the :get behavior."
  (if (null (third active-value))
      :default-get-behavior
      (third active-value)))

(def$method (active-value-mixin :default-get-behavior) (old-local-value active-value prop-name slot-name)
  (declare (ignore active-value prop-name slot-name))
  old-local-value)

(def$method (active-value-mixin :local-value) (active-value)
...
(def$method (active-value-mixin :put-behavior) (active-value)
  "selects the :put behavior."
  (if (null (fourth active-value))
      :default-put-behavior
      (fourth active-value)))

(def$method (active-value-mixin :default-put-behavior) (new-local-value active-value prop-name slot-name)
  (declare (ignore active-value prop-name slot-name))
  new-local-value)
