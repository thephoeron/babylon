...
(def$method (basic-frame-processor :kb-inform) (&optional (stream *standard-output*))
...
(def$method (basic-frame-processor :print) (&optional (stream *standard-output*)) 
...
#+:flavors(compile-$flavor-$methods basic-frame-processor)
