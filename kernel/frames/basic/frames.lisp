...
(defun print-frame-behavior (behavior-body &optional (stream *standard-output*))
  (babpprint (make-behavior-def behavior-body) stream))


(defun print-frames (frame-names &optional (stream *standard-output*))
...
(defun print-frame (frame-name &optional (stream *standard-output*))
  (print-frames (list frame-name) stream))


(defun print-instance-def (instance-name &optional (stream *standard-output*))
  (babpprint (get-instance-def instance-name) stream))

(defun print-instances (frame-name &optional (stream *standard-output*))
