...
#+MCS(def$method (normal-interface-mixin :after :toggle-frcheck) ()
...
(def$method (normal-interface-mixin :babylon-read) (&optional (key-list NIL))
  (let* ((line (string-left-trim '(#\ ) (read-line dialog-stream)))
         (char (if (> (length line) 0) (aref line 0) *c-help-key*)))
    (cond ((member char key-list :test 'char-equal) char)
          (t (read-from-string line nil)))))
