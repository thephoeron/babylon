...
(def$flavor simple-babylon
	()
	(select-mixin menu-loop lispm-dialog-mixin system-core))

 
(def$method (simple-babylon :after :init) (&rest ignore)
...
(def$method (simple-babylon :set-up-windows) ()
  t)
...
(def$method (simple-babylon :set-up-commands) ()
...
(compile-$flavor-$methods simple-babylon) 
