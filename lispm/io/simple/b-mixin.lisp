...
(def$flavor basic-interface-mixin
  ...
  (:documentation "an interface-mixin reading and writing to the stream
                   bound to *default-dialog-stream*")) 


(def$method (basic-interface-mixin :after :init) (&rest ignore)
...
(def$method (basic-interface-mixin :before :select-kb ) ()
