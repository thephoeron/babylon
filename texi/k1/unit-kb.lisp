...
(defbehavior (unit :before :initialize)
  (ignore)  
  ; (<- self :history-off)
  t)
...
(defbehavior (unit :after :initialize)
  (ignore)
...
(defbehavior (unit :after :create-part)
  (part-name unit-name with-spec)
...
(defbehavior (unit :describe-tree) (linking-slot &rest slot-names)
  (ignore linking-slot slot-names)
...
(defbehavior (physical-unit :after :create-part)
  (part-name unit-name with-spec)
