...
;
;  dummy-interface-mixin for Macintosh Coral Allegro Common Lisp
;
...
(def$method (dummy-interface-mixin :set-up-windows) ()
  ($send self :send-if-handles :set-explanation-window dialog-stream)
  ($send self :send-if-handles :set-system-trace-window dialog-stream)
  ($send self :send-if-handles :set-consat-trace-window dialog-stream)
  ($send self :send-if-handles :set-rule-trace-window dialog-stream)
  ($send self :send-if-handles :set-prolog-trace-window dialog-stream))
